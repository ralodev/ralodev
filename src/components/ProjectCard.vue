  ...
  <article class="relative group w-full rounded-3xl group p-2 min-h-[300px]">
    ...
    <div class="relative flex flex-col lg:grid lg:grid-cols-6">
      ...
      <div
        ...
        "
      >
        <h1 class="text-2xl font-bold text-ltext1 dark:text-dtext1">
          {{ title }}
        </h1>
        ...
        <div class="justify-evenly flex">
          <SecondaryButton v-if="source" label="Source">
            <svg
          ...
          <SecondaryButton v-if="demo" label="Demo">
            <svg
              class="w-6 h-6 text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <SecondaryButton v-if="info" label="Read case study">
            <svg
              class="w-6 h-6 text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
