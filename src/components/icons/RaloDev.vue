<template>
  <svg
    viewBox="761.672 800.1868 3447.7921 3427.1053"
    width="3447.7921"
    height="3427.1053"
  ...
  >
    <defs>
      <linearGradient
        ...
        gradientTransform="matrix(7.5,0,0,-7.5,9150,24367.5)"
        spreadMethod="pad"
        id="linearGradient28"
      >
        <stop
          style="stop-opacity: 1; stop-color: #447ffa"
          offset="0"
          id="stop22"
        />
        <stop
          style="stop-opacity: 1; stop-color: rgb(60, 111, 218)"
          offset="0.513"
          id="stop24"
        />
        <stop
          style="stop-opacity: 1; stop-color: rgb(27, 51, 101)"
          offset="1"
          id="stop26"
        />
      </linearGradient>
      ...
      >
        ...
        />
        <stop
          style="stop-opacity: 1; stop-color: rgb(63, 117, 230)"
          offset="0.513"
          id="stop42"
        />
        <stop
      ...
      >
        ...
        />
        <stop
          style="stop-opacity: 1; stop-color: rgb(59, 111, 217)"
          offset="0.513"
          id="stop96"
        />
        <stop
          style="stop-opacity: 1; stop-color: rgb(33, 62, 123)"
          offset="1"
          id="stop98"
        />
      </linearGradient>
    ...
    <g
      id="g8"
      transform="matrix(1.3333332538604734, 0, 0, -1.3333332538604734, 1.4210854715202004e-14, 5000)"
    >
      <g id="g10" transform="scale(0.1)">
        ...
        <g id="g32">
          <g id="g34" clip-path="url(#clipPath38)">
            <path
              d="M 5712.54,31498.6 V 26417.7 L 26334.9,5795.31 l 5080.9,0.04 z"
              style="
        ...
        <g id="g50">
          <g id="g52" clip-path="url(#clipPath56)" class="">
            <path
