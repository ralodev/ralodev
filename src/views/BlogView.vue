<template>
  <section class="relative pt-[80px]">
    <div class="absolute bg-grid inset-0 mt-20 z-0"></div>
    <div
      class="relative container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 dark:text-dtext2 text-ltext2"
    >
      <a
        rel="noopener noreferrer"
        href="#"
        class="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline cursor-pointer focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900"
      >
        <img
